...
class RegisterController: UIViewController {
    ...
    private let headerView = AuthHeaderView(title: "Sign Up", subTile: "Create your account")
    ...
    @objc func didTapSignUp() {
        ...
        let webViewer = WebViewerController(with: "https://cdn2.fptshop.com.vn/unsafe/Uploads/images/tin-tuc/167166/Originals/meme-ech-xanh-20.jpg")
